            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 m-auto">
                    <div class="single-action-item d-flex align-items-center">
                        ...
                        <div class="call-action-info">
                            ...
                            <p>Cho đơn hàng từ 2.000.000đ</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-action-item d-flex align-items-center">
                        ...
                        <div class="call-action-info">
                            <h4>30 ngày trả hàng</h4>
                            <p>Hoàn tiền dễ dàng</p>
                        </div>
                    </div>
                </div>
                <!-- Single Call to Action End -->
                ...
                <div class="product-content-wrap">
                    ...
                    <nav class="product-teb-menu">
                        <ul class="nav justify-content-center" role="tablist">
                            <li><a class="active" href="#new-products" id="new-product-tab" data-bs-toggle="tab">Sản phẩm mới nhất</a></li>
                            <li><a href="#sale-products" id="sale-product-tab" data-bs-toggle="tab">Giảm giá</a></li>
                            <li><a href="#feature-products" id="feature-product-tab" data-bs-toggle="tab">Tính năng</a></li>
                        </ul>
                    </nav>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="category-product-wrap">
                        <h4 class="cate-pro-title"><a href="shop.html">Máy tính bảng</a></h4>
                ...
                <div class="col-lg-6">
                    <div class="category-product-wrap">
                        <h4 class="cate-pro-title"><a href="shop.html">Máy tính để bàn</a></h4>
                        <figure class="cat-banner">
